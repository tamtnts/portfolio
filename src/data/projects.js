...
function buildContainerAccessibility(currentService) {
  return {
    ...
    relationships: [
      ...
      'Fleet Operations Core uses Operations PostgreSQL and the Operational Redis cache.',
      'Fleet Administration & Dispatch uses Administration PostgreSQL and the Administration Redis cache.',
      'Fleet Data Intelligence Hub uses Intelligence PostgreSQL and the Elasticsearch search index.',
    ],
...
const operationsComponentAccessibility = {
  ...
  relationships: [
    ...
    'The Persistence Adapter accesses PostgreSQL.',
...
const intelligenceComponentAccessibility = {
  ...
  relationships: [
    ...
    'Data Repositories access PostgreSQL.',
...
export const projects = [
  {
    ...
    contributions: [
      ...
      'Worked on PostgreSQL queries and use-case orchestration.',
    ...
    techStack: ['Java 17', 'Spring Boot', 'REST', 'gRPC', 'Kafka', 'Redis', 'Elasticsearch', 'PostgreSQL', 'OpenFeign', 'PDF and document generation', 'Docker'],
  ...
  },
  {
    ...
    techStack: ['Java 17', 'Spring Boot', 'REST', 'gRPC', 'Kafka', 'Redis', 'Elasticsearch', 'PostgreSQL', 'ShedLock', 'Docker'],
  ...
  },
  {
    ...
    tags: ['Java 17', 'Spring Boot', 'Kafka', 'Elasticsearch', 'PostgreSQL', 'gRPC'],
    disclaimer: 'This case study is generalized for confidentiality. Names, boundaries, and flows do not reproduce the private production system.',
    overview: {
    ...
    mainFlow: [
      ...
      'Query services select PostgreSQL or search-backed access for the request.',
    ...
    techStack: ['Java 17', 'Spring Boot', 'REST', 'gRPC', 'Kafka', 'Elasticsearch', 'PostgreSQL', 'OpenFeign', 'Docker'],
